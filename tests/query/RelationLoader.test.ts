...
import { RelationLoader, RelationMeta, ModelRelationMeta } from '../../src/query/RelationLoader';
  ...
  describe('loadRelations()', () => {
    describe('belongsTo relationships', () => {
      it('should load belongsTo relationship', async () => {
        ...
        const loader = new RelationLoader<TestPost>('Post', 'posts', relationMeta);
    ...
    describe('hasMany relationships', () => {
      it('should load hasMany relationship', async () => {
        ...
        const loader = new RelationLoader<TestUser>('User', 'users', relationMeta);
    ...
    describe('edge cases', () => {
      ...
      it('should warn and skip unknown relationships', async () => {
        const relationMeta: ModelRelationMeta = {};
        const users = [{ id: 1, email: 'test@test.com' }] as unknown as TestUser[];
